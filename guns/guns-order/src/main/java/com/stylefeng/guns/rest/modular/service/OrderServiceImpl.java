...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public List<OrderInfoVO> getOrderInfo(String username, PageInfoVO pageInfoVO) {
        List<OrderInfoVO> orderInfos = orderTMapper.selectOrdersByUsername(username,pageInfoVO);
        return orderInfos;
    }
