...
import com.stylefeng.guns.rest.common.exception.DataException;
...
public class GlobalExceptionHandler extends BaseControllerExceptionHandler {
    ...
    public ErrorTip notFount(RuntimeException e) {
        log.error("运行时异常:", e);
        return new ErrorTip(BizExceptionEnum.QUERY_ERROR.getCode(), BizExceptionEnum.QUERY_ERROR.getMessage());
    }
}
