...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("H:\\stu\\code\\microservice\\project\\lastProject\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_hall_film_info_t","mtime_film_info_t"});
